...
// import   pkg                             from  'ra-core'; const { fetchUtils, DataProvider } = pkg;
// const  { fetchUtils, DataProvider } = require( 'ra-core' );
 ...
 */
   ...
   export default ( function DataProvider( apiUrl, httpClient, countHeader ) {
...
//      ------------------------------------------------------------------------------------------------------------
      ...
      , getMany:function( resource, params ) {
       ...
       return   httpClient( url )
                  .then( function( _a ) { var json = _a.json; return ({ data: json } ); } );
        }
//      ------------------------------------------------------------------------------------------------------------
