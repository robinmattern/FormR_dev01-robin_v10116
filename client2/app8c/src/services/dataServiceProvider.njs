            ...
            dataService:
             {
              ...
              getManyRefs       GET    http://path.to.my.api/comments?sort=["created_at","DESC"]&range=[0, 24]&filter={"post_id":123}
              createOne         POST   http://path.to.my.api/posts                               { "title": "hello, world", "author_id": 12 }
              updateOne         PUT    http://path.to.my.api/posts/123                           { "title": "hello, world!" }
              updateMany        PUT    http://path.to.my.api/posts?filter ={"id":[123,124,125]}  { "title": "hello, world!" }
              deleteOne         DELETE http://path.to.my.api/posts/123
              deleteMany        DELETE http://path.to.my.api/posts?filter ={"id":[123,124,125]}
              deleteAll         DELETE http://path.to.my.api/posts?filter ={"id":[123,124,125]}
*//*
