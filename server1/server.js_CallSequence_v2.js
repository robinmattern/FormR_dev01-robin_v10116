...
-8   routes/user.routes[11]                const controller =  require(   `../controllers/${aTable}.controller.js` );             // .(10106.02.2 RAM Was: users )
...
-15  controllers/user.controller.js[78]  exports.findOne    = (req, res) => { ... }
     ...
     routes/user.routes[17]                      router.get(  '/',   controller.findAll )    // Retrieve all records
-11  routes/user.routes[24]                      app.use(     `/api/${aTable}`, router );    // Use '/api/users/' + router.methods
